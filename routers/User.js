...
const { register, verify, login, logout, getMyProfile, getAllProfile, updateProfile, updateAvatar, deleteProfile, updatePassword, forgetPassword, resetPassword, phonePassword, updateDeviceId, searchUser } = require("../controllers/User")
...
router.route("/deleteprofile").post(isAuthenticated, deleteProfile)
